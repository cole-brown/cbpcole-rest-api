...
* ├CURRENT┤ Push to GitHub private repo
:LOGBOOK:
...
Add in some tests for repeated UUIDs.

Make test randomly seed a known amount of users into known UTC yyyy-mm-dd.
...
* ├TODO───┤ TESTING-OF: /daily_uniques?d=<ISO-8601>: Take 02
...
Also test some months with known 0 users.
